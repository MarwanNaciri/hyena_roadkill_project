...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_road_importance (",
...
mean_sd <- read_csv(paste0("06_processed_data/glm_data_2021-04/predictor_mean_sd_", buffer.size, "m.csv"))
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_amenity (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_water (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_woodland (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
save_plot("07_intermediate_results/2021-04/plots/GLM_all.png", 
          plot = figure.GLM,
          ncol = 2,
          nrow = 2,
          base_asp = 1.618)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_expected_(dots)_VS_observed (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.5_road_importance (",
                         buffer.size, "m buffer).png"),
       width = 2, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.5_amenity (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.5_water (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.5_woodland (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
save_plot("07_intermediate_results/2021-04/plots/GLM_0.5_all.png", 
          plot = figure.GLM,
          ncol = 2,
          nrow = 2,
          base_asp = 1.618)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.5_expected_(dots)_VS_observed (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.75_road_importance (",
                         buffer.size, "m buffer).png"),
       width = 2, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.75_amenity (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.75_water (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.75_woodland (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)
...
save_plot("07_intermediate_results/2021-04/plots/GLM_0.75_all.png", 
          plot = figure.GLM,
          ncol = 2,
          nrow = 2,
          base_asp = 1.618)
...
ggsave(filename = paste0("07_intermediate_results/2021-04/plots/GLM_0.75_expected_(dots)_VS_observed (",
                         buffer.size, "m buffer).png"),
       width = 3, height = 3)