...
table.glm <- read_csv(paste0("06_processed_data/glm_data_2021-04/47.5km/table.glm_10.", 
                             buffer.size, "m.csv"))
...
DHARMa::plotResiduals(glm_nb_all, as.factor(table.glm$road_importance)) # No quantile deviation and no quadratic effect
...
table.glm.0.5 <- read_csv(paste0("06_processed_data/glm_data_2021-04/47.5km/table.glm_10.", 
...
table.glm.0.75 <- read_csv(paste0("06_processed_data/glm_data_2021-04/47.5km/table.glm_10.", 
