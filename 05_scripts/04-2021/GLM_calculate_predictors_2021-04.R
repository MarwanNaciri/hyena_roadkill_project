...
# roads <- rgdal::readOGR(dsn  =  "06_processed_data/roads/SNP.roads.QGIS/old",
...
write_csv(midpoint.and.length, "06_processed_data/glm_data_2021-04/midpoint.and.length.csv")
...
write_csv(table.glm_3.2, "06_processed_data/glm_data_2021-04/table.glm_3.2.csv")

#==============================================================================#
# STEP 4: Delete roads that are too far -----------------------------------

table.glm_3.2 <- read_csv("06_processed_data/glm_data_2021-04/table.glm_3.2.csv")
...
table.glm_4 <- DeleteSegmentFarFromCenter(table.glm_3.2, # Instantaneous
                                          ...
                                          lim.dist = 65000) 
# Save
write_csv(table.glm_4, "06_processed_data/glm_data_2021-04/table.glm_4.csv")
...
write_csv(roads.segmented.cropped.df, "06_processed_data/glm_data_2021-04/roads.segmented.cropped.df.csv")


#==============================================================================#
# STEP 5: Delete segments that are too short -----------------------------------------

table.glm_4 <- read_csv("06_processed_data/glm_data_2021-04/table.glm_4.csv")

table.glm_5 <- table.glm_4 %>%
  filter(length > 2000)

write_csv(table.glm_5, "06_processed_data/glm_data_2021-04/table.glm_5.csv")
...
write_csv(roads.segmented.cropped.no.short.df, "06_processed_data/glm_data_2021-04/roads.segmented.cropped.no.short.df.csv")


#==============================================================================#
# STEP 6: Count the number of carcasses on each segment ------------------------

table.glm_5 <- read_csv("06_processed_data/glm_data_2021-04/table.glm_5.csv")
roads.segmented.cropped.no.short.df <- read_csv("06_processed_data/glm_data_2021-04/roads.segmented.cropped.no.short.df.csv")
...
write_csv(table.glm_6, "06_processed_data/glm_data_2021-04/table.glm_6.csv")
...
table.glm_6 <- read_csv("06_processed_data/glm_data_2021-04/table.glm_6.csv")
...
write_csv(closest.water, "06_processed_data/glm_data_2021-04/closest.water.csv")
...
write_csv(table.glm_7, "06_processed_data/glm_data_2021-04/table.glm_7.csv")
...
### Load the data
snp.amenity.polygons <- rgdal::readOGR("06_processed_data/buildings", 
                                         layer = "buildings_polygons_for_analyses_2021-05-25")
snp.amenity.points <- rgdal::readOGR("06_processed_data/buildings", 
                                       layer = "building_points_for analyses_2020-09-11")

table.glm_7 <- read_csv("06_processed_data/glm_data_2021-04/table.glm_7.csv")
...
write_csv(closest.amenity, "06_processed_data/glm_data_2021-04/closest.amenity.csv")
...
write_csv(table.glm_8, "06_processed_data/glm_data_2021-04/table.glm_8.csv")
...
table.glm_8 <- read_csv("06_processed_data/glm_data_2021-04/table.glm_8.csv")
...
# Save
save(land.cover.seg, 
     file = paste0("06_processed_data/glm_data_2021-04/extracted_cell_cover_values_", buffer.size, "m", ".RData"))
write_csv(percentage.land.cover, 
          path = paste0("06_processed_data/glm_data_2021-04/percentage.land.cover.", buffer.size, "m", ".csv"))
write_csv(percentage.land.cover.processed, 
          path = paste0("06_processed_data/glm_data_2021-04/percentage.land.cover.", buffer.size, "m.processed.csv"))

percentage.land.cover.processed <- read_csv(paste0("06_processed_data/glm_data_2021-04/percentage.land.cover.", 
...
write_csv(table.glm_9, 
          path = paste0("06_processed_data/glm_data_2021-04/table.glm_9.", buffer.size, "m.csv"))
...
buffer.size <- 500
table.glm_9 <- read_csv(paste0("06_processed_data/glm_data_2021-04/table.glm_9.", buffer.size, "m.csv"))
...
write_csv(table.glm_10, 
          path = paste0("06_processed_data/glm_data_2021-04/table.glm_10.", buffer.size, "m.csv"))
...
write_csv(predictor_mean_sd, 
          path = paste0("06_processed_data/glm_data_2021-04/predictor_mean_sd_", buffer.size, "m.csv"))
...
table.glm_5 <- read_csv("06_processed_data/glm_data_2021-04/table.glm_5.csv")
table.glm_10 <- read_csv(paste0("06_processed_data/glm_data_2021-04/table.glm_10.", 
                                buffer.size, "m.csv"))
roads.segmented.cropped.no.short.df <- read_csv("06_processed_data/glm_data_2021-04/roads.segmented.cropped.no.short.df.csv")
...
write_csv(table.glm_10_0.5, 
          path = paste0("06_processed_data/glm_data_2021-04/table.glm_10.", buffer.size, "m.0.5.csv"))
...
write_csv(table.glm_10_0.75, 
          path = paste0("06_processed_data/glm_data_2021-04/table.glm_10.", buffer.size, "m.0.75.csv"))
