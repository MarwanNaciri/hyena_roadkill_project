...
x <- hy_carcasses_season_w_transit_spatial %>%
  group_by(herds_position_w_transit) %>%
  summarize(median_long = median(long))
x$median_long[1] - x$median_long[2] 
y <- hy_carcasses_season_w_transit_spatial %>%
  group_by(herds_position_w_transit) %>%
  summarize(median_lat = median(lat))
y$median_lat[1] - y$median_lat[2]
...
add <- data.frame(year = years[-remove],
                  n = 0,
                  rate = seq(0.00000001, 0.00000011, by = 0.00000001), # to avoid ties
                  rate_100km = seq(0.000001, 0.000011, by = 0.000001))
