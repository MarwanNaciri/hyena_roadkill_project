...
write_csv(roads.segmented.df, "06_processed_data/glm_data_2022-04/roads.segmented.df.csv")
...
roads.segmented.df <- read_csv("06_processed_data/glm_data_2022-04/roads.segmented.df.csv")
...
write_csv(midpoint.and.length, "06_processed_data/glm_data_2022-04/midpoint.and.length.csv")
...
write_csv(table.glm_3.2, "06_processed_data/glm_data_2022-04/table.glm_3.2.csv")

# STEP 4: Delete segments that are too short -----------------------------------------

table.glm_3.2 <- read_csv("06_processed_data/glm_data_2022-04/table.glm_3.2.csv")

table.glm_4 <- table.glm_3.2 %>%
  filter(length > 2000)

write_csv(table.glm_4, "06_processed_data/glm_data_2022-04/table.glm_4.csv")
...
write_csv(roads.segmented.cropped.no.short.df, "06_processed_data/glm_data_2022-04/roads.segmented.cropped.no.short.df.csv")


#==============================================================================#
# STEP 5: Count the number of carcasses on each segment ------------------------

table.glm_4 <- read_csv("06_processed_data/glm_data_2022-04/table.glm_4.csv")
...
hy_carcasses_formatted_spatial <- read_delim("06_processed_data/carcasses/12_hy.carcasses.certainty.formatted.spatial_updated_2022-04.csv", 
...
write_csv(table.glm_5, "06_processed_data/glm_data_2022-04/table.glm_5.csv")
...
table.glm_5 <- read_csv("06_processed_data/glm_data_2022-04/table.glm_5.csv")
...
save(closest.water, 
     file = "06_processed_data/glm_data_2022-04/closest.water.RData")
write_csv(closest.water, "06_processed_data/glm_data_2022-04/closest.water.csv")



closest.water <- read_csv("06_processed_data/glm_data_2022-04/closest.water.csv")
...
write_csv(table.glm_6, "06_processed_data/glm_data_2022-04/table.glm_6.csv")
...
table.glm_6 <- read_csv("06_processed_data/glm_data_2022-04/table.glm_6.csv")
...
write_csv(closest.amenity, "06_processed_data/glm_data_2022-04/closest.amenity.csv")
closest.amenity <- read_csv("06_processed_data/glm_data_2022-04/closest.amenity.csv")
...
write_csv(table.glm_7, "06_processed_data/glm_data_2022-04/table.glm_7.csv")


#==============================================================================#
# STEP 8: Extract land cover percentages --------------------------------------

table.glm_7 <- read_csv("06_processed_data/glm_data_2022-04/table.glm_7.csv")
...
# Save
save(land.cover.seg, 
     file = paste0("06_processed_data/glm_data_2022-04/extracted_cell_cover_values_", buffer.size, "m", ".RData"))
write_csv(percentage.land.cover, 
          file =  paste0("06_processed_data/glm_data_2022-04/percentage.land.cover.", buffer.size, "m", ".csv"))
write_csv(percentage.land.cover.processed, 
          file =  paste0("06_processed_data/glm_data_2022-04/percentage.land.cover.", buffer.size, "m.processed.csv"))

percentage.land.cover.processed <- read_csv(paste0("06_processed_data/glm_data_2022-04/percentage.land.cover.", 
...
write_csv(table.glm_8, 
          file =  paste0("06_processed_data/glm_data_2022-04/table.glm_8.", buffer.size, "m.csv"))

#==============================================================================#
# STEP 9: Scale the variables -------------------------------------------------
buffer.size <- 500
table.glm_8 <- read_csv(paste0("06_processed_data/glm_data_2022-04/table.glm_8.", buffer.size, "m.csv"))
...
write_csv(table.glm_9, 
          file =  paste0("06_processed_data/glm_data_2022-04/table.glm_9.", buffer.size, "m.csv"))
...
write_csv(predictor_mean_sd, 
          file =  paste0("06_processed_data/glm_data_2022-04/predictor_mean_sd_", buffer.size, "m.csv"))


# B. Visualize the variables ===================================================

buffer.size <- 500
table.glm_8 <- read_csv(paste0("06_processed_data/glm_data_2022-04/table.glm_8.", buffer.size, "m.csv"))

ggplot(table.glm_8, aes(x = distance_amenity_km)) + 
  geom_histogram()

ggplot(table.glm_8, aes(x = distance_water_km)) + 
  geom_histogram()

ggplot(table.glm_8, aes(x = woodland)) + 
  geom_histogram()
