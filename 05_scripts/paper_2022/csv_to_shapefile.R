...
# Import csv
hy_carcasses_high_certainty <- read_delim("06_processed_data/carcasses/12_hy.carcasses.certainty.formatted.spatial_updated_2022-04.csv", 
                                          ";", escape_double = FALSE, trim_ws = TRUE)  %>%
  mutate(clan_members = ifelse(ID_OG %in% c("Z112", "Z141", "Z142", "Z147", "Z156", "Z160", "Z164",
                                            "Z166","Z175", "Z178", "P518", "Z193", "Z196"), "yes", "no")) %>%
...
writeOGR(shp_hy_carcasses_clan_members, 
         dsn = "06_processed_data/carcasses",
         layer = "hy_carcasses_clan_members_2022-04",
         driver = "ESRI Shapefile", overwrite=TRUE)
